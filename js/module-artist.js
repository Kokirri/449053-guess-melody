...
const moduleArtist = getElement(`<section class="main main--level main--level-artist">
...
const answerButton = moduleArtist.querySelectorAll(`.main-answer-r`);
answerButton.forEach(function (button) {
  button.addEventListener(`click`, function () {
    removeSection(moduleArtist);
    showSection(moduleGenre);
  });
});

export default moduleArtist;
